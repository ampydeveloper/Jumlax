...
Route::group(['namespace' => 'User', 'as' => 'user.'], function () {
    Route::group(['middleware' => 'auth'], function () {
            Route::get('mytrip', 'AccountController@myTripe')->name('mytrip');
    });
});
...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::post('update', 'UpdatePasswordController@changePassword')->name('update');
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        // Registration Routes
        Route::get('charter-register', [RegisterController::class, 'showCharterRegistrationForm'])->name('charter-register');
//        Route::post('register', [RegisterController::class, 'register'])->name('register.post');
