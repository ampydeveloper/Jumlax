                            ...
                            <div class="rd-navbar-inner">
                                <div class="rd-navbar-panel">
                                    ...
                                    <div class="rd-navbar-brand">
                                        <a class="d-inline-block brand-name" href="{{url('/')}}">
                                        </a>
                                        <!--<img class="img-responsive center-block pull-left" src="{{ asset('/images/logo-white.png') }}" width="166" height="55" alt="">-->
                                        <img class="img-responsive center-block pull-left" src="{{ asset('/images/jumlax-partners.jpg') }}" style="height: 50px; width: 50px; margin: 4px 10px; border-radius:7px;">
                                    </div>
                                </div>
