...
@section('title', app_name() . ' | Add Charter Flight Details')
...
<div class="card">
    <div class="card-body"> 
        ...
        <div class="row mt-4">
            <div class="col">
                {{ html()->form('POST', route('admin.flight-details-save'))->class('form-horizontal')->open() }}
