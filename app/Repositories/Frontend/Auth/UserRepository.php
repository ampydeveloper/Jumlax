...
class UserRepository extends BaseRepository {
    ...
    public function create(array $data) {
        return DB::transaction(function () use ($data) {
                    ...
                    //Role Retailer
                        ...
                        $addCharterDetails->user_id = $user->id;
                        $addCharterDetails->name = $data['charter_name'];
                        $addCharterDetails->country = $data['country'];
    ...
    public function update($id, array $input, $image = false) {
        ...
        $user->representative_name = isset($input['representative_name']) ? $input['representative_name'] : '';
        $user->organization_name = isset($input['organization_name']) ? $input['organization_name'] : '';
